...
func (pInst *CTableHelper1) InsertIDKeyValue(id int64, key, value string) error {
	...
	strSql := "insert into " + pInst.tableName + " (id, key, valuestr) values ($1,$2,$3);"

	_, err := pInst.dbInst.ExecSql(strSql, id, key, value)
	//_, err := pInst.dbInst.GetDBHandler().Exec(strSql, id, key, value)
...
func (pInst *CTableHelper1) InsertKeyValue(key, value string) error {
	...
	strSql := "insert into " + pInst.tableName + "(key, valuestr) values ($1, $2);"
